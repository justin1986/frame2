	...
	<table width="795" border="0" id="list">
		...
		?>
				...
				<tr class="tr3" style="display:none;" id=<?php echo $record2[$j]->id;?> name="<?php echo $record[$i]->name;?>">
					...
					<td><a href="menu_edit.php?id=<?php echo $record2[$j]->id;?>" target="admin_iframe" title="编辑"><img src="/images/btn_edit.png" border="0"></a>　<a class="del" name="<?php echo $record2[$j]->id;?>" style="color:#ff0000; cursor:pointer" title="删除"><img src="/images/btn_delete.png" border="0"></a></td>
				</tr>
		<?php
					}
				}
