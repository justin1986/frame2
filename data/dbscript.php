...
$db_script_str .= "insert into `{$db_database_name}`.`{$table_prex}admin_menu` (name,href,parent_id,description,priority,target,is_root) values ('系统管理','#',0,'系统管理',3,'#',1);";
...
$db_script_str .= "insert into `{$db_database_name}`.`{$table_prex}admin_menu` (name,href,parent_id,description,priority,target,is_root) values ('图片类别管理','/admin/category/category_list.php?type=picture',2,'图片类别管理',2,'#',0);";
...
$db_script_str .= "insert into `{$db_database_name}`.`{$table_prex}admin_menu` (name,href,parent_id,description,priority,target,is_root) values ('菜单管理','/admin/menu/menu_list.php',1,'菜单管理',1,'admin_iframe',0);";
$db_script_str .= "insert into `{$db_database_name}`.`{$table_prex}admin_menu` (name,href,parent_id,description,priority,target,is_root) values ('用户管理','/admin/user/user_list.php',1,'用户管理',2,'admin_iframe',0);";
$db_script_str .= "insert into `{$db_database_name}`.`{$table_prex}admin_menu` (name,href,parent_id,description,priority,target,is_root) values ('数据库管理','/admin/dbadmin/',1,'数据库管理',2,'admin_iframe',0);";
$db_script_str .= "insert into `{$db_database_name}`.`{$table_prex}user` (name,nick_name,password,role_name) values ('admin','超级管理员','admin','admin');";
